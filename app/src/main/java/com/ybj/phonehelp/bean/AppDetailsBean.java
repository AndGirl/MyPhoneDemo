...
public class AppDetailsBean implements Serializable{
    ...
    private List<AppDetailsBean> relateAppDetailsBeanList;
    ...
    //    private List<AppDetailsBean> appArticleInfoList;
    private String introduction;
    private String keyWords;
    private long updateTime;
    private int grantCode;
    private String detailHeaderImage;
    //    private List<AppDetailsBean> moduleInfoList;
    private int versionCode;
    private List<Tag> appTags;
    private int diffFileSize;
    private List<AppDetailsBean> sameDevAppDetailsBeanList;
    ...
    public void setRelateAppDetailsBeanList(List<AppDetailsBean> relateAppDetailsBeanList) {
        this.relateAppDetailsBeanList = relateAppDetailsBeanList;
    }
    ...
    public void setSameDevAppDetailsBeanList(List<AppDetailsBean> sameDevAppDetailsBeanList) {
        this.sameDevAppDetailsBeanList = sameDevAppDetailsBeanList;
    }
    ...
    public List<AppDetailsBean> getRelateAppDetailsBeanList() {
        return relateAppDetailsBeanList;
    }
    ...
    public List<AppDetailsBean> getSameDevAppDetailsBeanList() {
        return sameDevAppDetailsBeanList;
    }
