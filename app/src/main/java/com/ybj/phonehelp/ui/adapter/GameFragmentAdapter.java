...
public class GameFragmentAdapter extends BaseQuickAdapter<GameBean.DatasBean,BaseViewHolder>{
    ...
    public GameFragmentAdapter(@LayoutRes int layoutResId) {
        super(layoutResId);
    }

    @Override
    protected void convert(BaseViewHolder helper, GameBean.DatasBean item) {
