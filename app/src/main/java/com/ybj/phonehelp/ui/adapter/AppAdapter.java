...
public class AppAdapter extends BaseQuickAdapter<RecommendBean.RecommendAppsBean, BaseViewHolder> {
    ...
    public AppAdapter(@LayoutRes int layoutResId, @Nullable List<RecommendBean.RecommendAppsBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, RecommendBean.RecommendAppsBean item) {
